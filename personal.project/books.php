      ...
      <h2>Books</h2>
       ...
       <form action="addBook.php" method="post">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Book Title" name="book_title" >
          <label for="floatingInput">Book Title</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Book Description" name="book_desc" >
          <label for="floatingInput">Book Description</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Quality" name="book_genre" >
          <label for="floatingInput">Book Genre</label>
        </div>
        <div class="form-floating">
          <input type="number" class="form-control" id="floatingInput" placeholder="Rating" name="year_published" >
          <label for="floatingInput">Year Published</label>
        </div>
        <div class="form-floating">
          <input type="file" class="form-control" id="floatingInput" placeholder="Image" name="book_image" >
