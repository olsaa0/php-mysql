  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Book title" name="book_title" value="<?php echo  $user_data['book_title'] ?>">
          <label for="floatingInput">Book Title</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Book description" name="book_desc" value="<?php echo  $user_data['book_desc'] ?>">
          <label for="floatingInput">Book description</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Book genre" name="book_genre" value="<?php echo  $user_data['book_genre'] ?>">
          <label for="floatingInput">Book genre</label>
        </div>
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Movie Rating" name="year_published" value="<?php echo  $user_data['year_published'] ?>">
          <label for="floatingInput">Year published</label>
        </div>
        <br>
